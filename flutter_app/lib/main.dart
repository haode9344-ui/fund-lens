...
class FundService {
  ...
  Future<FundAnalysis> load(PortfolioItem item) async {
    ...
    final live = _analyze(fund, holdings, announcements, market, smartMoney, theme, realtime, intraday, tailSignals, settledItem, holdingSourceText);
